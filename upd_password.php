                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                         ...
                         <div class="contact-us-content">
                            ...
                            <p class="success_alert1" style="color:green; display:none;"></p>
                          ...
                          <div class="form-group">
                                ...
                                <small class="password_err" style="color:red; display:none;">Please Enter Password</small>
                            ...
                            <div class="form-group">
                                ...
                                <small class="password_err1" style="color:red; display:none;">Please Enter Confirm Password</small>
     ...
     <script>
      $(document).ready(function() {
        ...
        $('.updpassbtn').click(function(e){
            ...
            $('.password_err1').hide();   
            $('.success_alert1').show();
            $(".success_alert1").html("<p>"+data.response+"</p>");
            $('.err_alert').hide();   
